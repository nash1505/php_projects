...
$sqlCommand="INSERT into npt(head,subhead,content,publishdate,company_photo) values('$head','$subhead','$content','$publishdate','$new_pic')";
...
<center>
      ...
      <button class="btn btn-lg btn-primary btn-block" type="submit" name="update">update</button>  <br><br>
            <button class="btn btn-lg btn-primary btn-block"><a href="technology.php">back</a></button>  </center>
