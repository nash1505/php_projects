      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            <h1><?php echo $arrayt[count($row_selectt)-3];?></h1>
            <div class="post_commentbox"> <a href="#"><i class="fa fa-user"></i></a> आपली बातमी<span><i class="fa fa-calendar"></i><?php $date=new DateTime('now' , new DateTimeZone('Asia/Kolkata'));
              echo $date->format('d-m-Y H:i:s') ?></p></span> <a href="#"><i class="fa fa-tags"></i>Technology</a> </div>
            <div class="single_page_content"> <img class="img-center" src="../images/<?php echo $arraytp[count($row_selectt)-3];?>" alt="">
              <p><?php echo $arraytc[count($row_selectt)-3];?></p>
            ...
            <div class="related_post">
              ...
              <ul class="spost_nav wow fadeInDown animated">
                <li>
                  <div class="media"> <a class="media-left" href="np1.php"> <img src="../images/<?php echo $arraytp[count($row_selectt)-2];?>" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="np1.php"> <?php echo $arrayt[count($row_selectt)-2];?></a> </div>
                  </div>
                </li>
                <li>
                  <div class="media"> <a class="media-left" href="np2.php"> <img src="../images/<?php echo $arraytp[count($row_selectt)-3];?>" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="np2.php"> <?php echo $arrayt[count($row_selectt)-3];?></a> </div>
                  </div>
                </li>
                <li>
                  <div class="media"> <a class="media-left" href="np3.php"> <img src="../images/<?php echo $arraytp[count($row_selectt)-4];?>.jpg" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="np3.php"> <?php echo $arrayt[count($row_selectt)-4];?></a> </div>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <div class="col-lg-4 col-md-4 col-sm-4">
        <aside class="right_content">
          <div class="single_sidebar">
            ...
            <ul class="spost_nav">
              <li>
                <div class="media wow fadeInDown"> <a href="single_page.php" class="media-left"> <img alt="" src="../images/<?php echo $arraytp[count($row_selectt)-1];?>"> </a>
                  <div class="media-body"> <a href="single_page.php" class="catg_title"> <?php echo $arrayt[count($row_selectt)-1];?></a> </div>
                </div>
              </li>
              <li>
                <div class="media wow fadeInDown"> <a href="np1.php" class="media-left"> <img alt="" src="../images/<?php echo $arraytp[count($row_selectt)-2];?>"> </a>
                  <div class="media-body"> <a href="np1.php" class="catg_title"> <?php echo $arrayt[count($row_selectt)-2];?></a> </div>
                </div>
              </li>
              <li>
                <div class="media wow fadeInDown"> <a href="np2.php" class="media-left"> <img alt="" src="../images/<?php echo $arraytp[count($row_selectt)-3];?>"> </a>
                  <div class="media-body"> <a href="np2.php" class="catg_title"> <?php echo $arrayt[count($row_selectt)-3];?></a> </div>
                </div>
              </li>
              <li>
                <div class="media wow fadeInDown"> <a href="np3.php" class="media-left"> <img alt="" src="../images/<?php echo $arraytp[count($row_selectt)-4];?>"> </a>
                  <div class="media-body"> <a href="np3.php" class="catg_title"> <?php echo $arrayt[count($row_selectt)-4];?></a> </div>
                </div>
              </li>
            </ul>
          </div>
