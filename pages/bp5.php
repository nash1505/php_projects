      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            <h1><?php echo $arrayb[count($row_selectB)-5];?></h1>
            ...
            <div class="single_page_content"> <img class="img-center" src="../images/<?php echo $arraybp[count($row_selectB)-5];?>" alt="">
              <p><?php echo $arraybc[count($row_selectB)-5];?></p>
