      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            <h1><?php echo $arraye[count($row_selecte)-2];?></h1>
            ...
            <div class="single_page_content"> <img class="img-center" src="../images/<?php echo $arrayep[count($row_selecte)-2];?>" alt="">
              <p><?php echo $arrayec[count($row_selecte)-2];?></p>
