      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            <h1><?php echo $array[count($row_select)-3];?></h1>
            ...
            <div class="single_page_content"> <img class="img-center" src="../images/<?php echo $arrayp[count($row_select)-3];?>" alt="">
              <p><?php echo $arraycc[count($row_select)-3];?></p>
