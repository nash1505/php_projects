...
$arrayt = array_column($row_selectt, 'head');
          ...
          $arrayec = array_column($row_selecte, 'content');
          ...
          $arraybc = array_column($row_selectB, 'content');
      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            <h1><?php echo $arrayb[count($row_selectB)-3];?></h1>
            ...
            <div class="single_page_content"> <img class="img-center" src="../images/<?php echo $arraybp[count($row_selectB)-3];?>" alt="">
              <p><?php echo $arraybc[count($row_selectB)-3];?></p>
            ...
            <div class="related_post">
              ...
              <ul class="spost_nav wow fadeInDown animated">
                <li>
                  <div class="media"> <a class="media-left" href="bp1.php"> <img src="../images/<?php echo $arraybp[count($row_selectB)-1];?>" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="bp1.php"> <?php echo $arrayb[count($row_selectB)-1];?></a> </div>
                  </div>
                </li>
                <li>
                  <div class="media"> <a class="media-left" href="bp2.php"> <img src="../images/<?php echo $arraybp[count($row_selectB)-2];?>" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="bp2.php"> <?php echo $arrayb[count($row_selectB)-2];?></a> </div>
                  </div>
                </li>
                <li>
                  <div class="media"> <a class="media-left" href="bp3.php"> <img src="../images/<?php echo $arraybp[count($row_selectB)-3];?>.jpg" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="bp3.php"> <?php echo $arrayb[count($row_selectB)-3];?></a> </div>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <div class="col-lg-4 col-md-4 col-sm-4">
        <aside class="right_content">
          <div class="single_sidebar">
            ...
            <ul class="spost_nav">
              <li>
                <div class="media wow fadeInDown"> <a href="bp1.php" class="media-left"> <img alt="" src="../images/<?php echo $arraybp[count($row_selectB)-1];?>"> </a>
                  <div class="media-body"> <a href="bp1.php" class="catg_title"> <?php echo $arrayb[count($row_selectB)-1];?></a> </div>
                </div>
              </li>
              <li>
                <div class="media wow fadeInDown"> <a href="bp2.php" class="media-left"> <img alt="" src="../images/<?php echo $arraybp[count($row_selectB)-2];?>"> </a>
                  <div class="media-body"> <a href="bp2.php" class="catg_title"> <?php echo $arrayb[count($row_selectB)-2];?></a> </div>
                </div>
              </li>
              <li>
                <div class="media wow fadeInDown"> <a href="bp3.php" class="media-left"> <img alt="" src="../images/<?php echo $arraybp[count($row_selectB)-3];?>"> </a>
                  <div class="media-body"> <a href="bp3.php" class="catg_title"> <?php echo $arrayb[count($row_selectB)-3];?></a> </div>
                </div>
              </li>
              <li>
                <div class="media wow fadeInDown"> <a href="bp4.php" class="media-left"> <img alt="" src="../images/<?php echo $arraybp[count($row_selectB)-4];?>"> </a>
                  <div class="media-body"> <a href="bp4.php" class="catg_title"> <?php echo $arrayb[count($row_selectB)-4];?></a> </div>
                </div>
              </li>
            </ul>
          </div>
