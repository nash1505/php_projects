      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            <h1><?php echo $arrayt[count($row_selectt)-4];?></h1>
            ...
            <div class="single_page_content"> <img class="img-center" src="../images/<?php echo $arraytp[count($row_selectt)-4];?>" alt="">
              <p><?php echo $arraytc[count($row_selectt)-4];?></p>
            ...
            <div class="related_post">
              ...
              <ul class="spost_nav wow fadeInDown animated">
                ...
                <li>
                  <div class="media"> <a class="media-left" href="#"> <img src="../images/<?php echo $arraytp[count($row_selectt)-4];?>.jpg" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="#"> <?php echo $arrayt[count($row_selectt)-4];?></a> </div>
                  </div>
                </li>
              </ul>
            </div>
