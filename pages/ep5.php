      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            <h1><?php echo $arraye[count($row_selecte)-5];?></h1>
            ...
            <div class="single_page_content"> <img class="img-center" src="../images/<?php echo $arrayep[count($row_selecte)-5];?>" alt="">
              <p><?php echo $arrayec[count($row_selecte)-5];?></p>
            ...
            <div class="related_post">
              ...
              <ul class="spost_nav wow fadeInDown animated">
                <li>
                  <div class="media"> <a class="media-left" href="ep1.php"> <img src="../images/<?php echo $arrayep[count($row_selecte)-1];?>" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="ep1.php"> <?php echo $arraye[count($row_selecte)-1];?></a> </div>
                  </div>
                </li>
                <li>
                  <div class="media"> <a class="media-left" href="ep2.php"> <img src="../images/<?php echo $arrayep[count($row_selecte)-2];?>" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="ep2.php"> <?php echo $arraye[count($row_selecte)-2];?></a> </div>
                  </div>
                </li>
                <li>
                  <div class="media"> <a class="media-left" href="ep3.php"> <img src="../images/<?php echo $arrayep[count($row_selecte)-3];?>" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="ep3.php"> <?php echo $arraye[count($row_selecte)-3];?></a> </div>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <div class="col-lg-4 col-md-4 col-sm-4">
        <aside class="right_content">
          <div class="single_sidebar">
            ...
            <ul class="spost_nav">
              <li>
                <div class="media wow fadeInDown"> <a href="ep1.php" class="media-left"> <img alt="" src="../images/<?php echo $arrayep[count($row_selecte)-1];?>"> </a>
                  <div class="media-body"> <a href="ep1.php" class="catg_title"> <?php echo $arraye[count($row_selecte)-1];?></a> </div>
                </div>
              </li>
              <li>
                <div class="media wow fadeInDown"> <a href="ep2.php" class="media-left"> <img alt="" src="../images/<?php echo $arrayep[count($row_selecte)-2];?>"> </a>
                  <div class="media-body"> <a href="ep2.php" class="catg_title"> <?php echo $arraye[count($row_selecte)-2];?></a> </div>
                </div>
              </li>
              <li>
                <div class="media wow fadeInDown"> <a href="ep3.php" class="media-left"> <img alt="" src="../images/<?php echo $arrayep[count($row_selecte)-3];?>"> </a>
                  <div class="media-body"> <a href="ep3.php" class="catg_title"> <?php echo $arraye[count($row_selecte)-3];?></a> </div>
                </div>
              </li>
              <li>
                <div class="media wow fadeInDown"> <a href="ep4.php" class="media-left"> <img alt="" src="../images/<?php echo $arrayep[count($row_selecte)-4];?>"> </a>
                  <div class="media-body"> <a href="ep4.php" class="catg_title"> <?php echo $arraye[count($row_selecte)-4];?></a> </div>
                </div>
              </li>
            </ul>
          </div>
