      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            <h1><?php echo $arrayt[count($row_selectt)-2];?></h1>
            ...
            <div class="single_page_content"> <img class="img-center" src="../images/<?php echo $arraytp[count($row_selectt)-2];?>" alt="">
              <p><?php echo $arraytc[count($row_selectt)-1];?></p>
            ...
            <div class="related_post">
              ...
              <ul class="spost_nav wow fadeInDown animated">
                <li>
                  <div class="media"> <a class="media-left" href="#"> <img src="../images/<?php echo $arraytp[count($row_selectt)-2];?>" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="#"> <?php echo $arrayt[count($row_selectt)-2];?></a> </div>
                  </div>
                </li>
                <li>
      ...
      <div class="col-lg-4 col-md-4 col-sm-4">
        <aside class="right_content">
          <div class="single_sidebar">
            ...
            <ul class="spost_nav">
              <li>
                <div class="media wow fadeInDown"> <a href="single_page.php" class="media-left"> <img alt="" src="../images/<?php echo $arrayt[count($row_selectt)-1];?>"> </a>
