      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          ...
          $arraytp = array_column($row_selectt, 'company_photo');
            ...
            <h1><?php echo $arrayt[count($row_selectt)-1]?></h1>
            ...
            <div class="single_page_content"> <img class="img-center" src="../images/<?php echo $arraytp[count($row_selectt)-1]?>" alt="">
      ...
      <div class="col-lg-4 col-md-4 col-sm-4">
        <aside class="right_content">
          <div class="single_sidebar">
            ...
            <ul class="spost_nav">
              <li>
                <div class="media wow fadeInDown"> <a href="#" class="media-left"> <img alt="" src="../images/<?php echo $arraytp[count($row_selectt)-1]?>"> </a>
                  <div class="media-body"> <a href="#" class="catg_title"> <?php echo $arrayt[count($row_selectt)-1]?></a> </div>
                </div>
              </li>
              <li>
