...
<div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <!-- End Navbar -->
      <div class="content">
        <a href="editt.php"><button type="button">ADD</button></a>
          <div class="row">
            
            
              <div class="card">
                <div class="card-header card-header-warning">
                  <h4 class="card-title">Technology News</h4>
    ...
    ?>
                      <tr>
                        ...
                        <td><?php echo $row_selectt[$i]['publishdate'];?></td>
                        <td><img src="images/<?php echo $row_selectt[$i]['company_photo'];?>" height="50px" width="50px"></td>
                      </tr>
                      <?php
                        }
                        ?>
